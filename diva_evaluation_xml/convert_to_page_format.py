...
output_folder='csg863_jults_identity_neighbour_blobs_merge_result_xml/'
os.makedirs(output_folder,exist_ok=True )
polygon_labels_dir= 'csg863_jults_identity_neighbour_blobs_merge_result/'
original_pages_dir= 'CSG863/'
crop_pages_dir='csg863/'
